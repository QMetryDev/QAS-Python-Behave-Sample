...
Scenario: VerifyCreditedAmount
  ...
  # Maximize browser window. (Custom bdd step - Find the definition at stepdefs.web)
  ...
  # Verify current updated balance(Custom bdd step - Find the definition at stepdefs.web)
